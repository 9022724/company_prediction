...
def do_work(file1, file2, model_type):
    ...
    def data_preprocessing(fil1, file2):
        ...
        return labels, df, companynames, num_cols, df_trial, df_trial_original
    ...
    def evaluate_all_models(df, labels):
        ...
        # plt.savefig("/Users/harib/Desktop/Personal/fastapi-hello-world/Accuracy_Precision_Recall_F1.pdf")
        # #     plt.show()
    ...
    labels, df, companynames, num_cols, df_trial, df_trial_original = data_preprocessing(file1,file2)
        ...
        # "/Users/harib/Desktop/Personal/fastapi-hello-world/Latest samples short list doctored.csv")
